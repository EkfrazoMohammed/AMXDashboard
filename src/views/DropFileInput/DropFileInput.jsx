  ...
  return (
    <>
      ...
      >
        ...
        <FontAwesomeIcon icon={faFileUpload}   size="2xl" style={{color: "#022869",}} />
    ...
    <div
      ...
      >
        <div className="drop-file-input__label">
          <FontAwesomeIcon
            ...
            style={{ color: '#002f80' }}
          />
          <FontAwesomeIcon icon="fas fa-folder-upload" style={{color: "#002f80",}} />
      ...
      {fileList.length > 0 && (
        <div className="drop-file-preview">
          <p style={{ color: '#3670ce' ,fontWeight:'bold'}} className="drop-file-preview__title">
